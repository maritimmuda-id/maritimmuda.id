        ...
        <div class="container margin-10px-top">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 sm-margin-seven-bottom xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.2s">
                ...
                <figure>
                    ...
                    <figcaption>
                        <div class="team-member-position margin-20px-top text-center">
                            <div class="text-small font-weight-500 text-extra-dark-gray ">Letjen TNI Marinir (Purn.)<br>Dr. Nono Sampono, M.Si.</div>
                ...
                <figure>
                    ...
                    <figcaption>
                        <div class="team-member-position margin-20px-top text-center">
                            ...
                            <div class="text-extra-small text-uppercase text-medium-gray">Kepala Badan Penyuluhan dan Pengembangan SDM Kelautan dan Perikanan</div>
                        </div>
                    </figcaption>
                </figure>
            </div>
                    ...
                    <figcaption>
                        <div class="row">
                            <div class="team-member-position margin-20px-top text-center">
                                ...
                                <div class="text-extra-small text-uppercase text-medium-gray">Member of International Federation of Business and Professional Women</div>
                            </div>
                        </div>
                    </figcaption>
                </figure>
