            ...
            <div class="container margin-one-bottom">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 text-center center-col margin-eight-bottom xs-margin-30px-bottom last-paragraph-no-margin">
                        <img src="<?php echo site_url('assets') ?>/images/arungisamudra/logo/logo-arungisamudra-edutrip.png" alt="" class="border-radius-6 width-60" style="margin-bottom: 50px;">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 text-center center-col margin-eight-bottom xs-margin-30px-bottom last-paragraph-no-margin">
                            ...
                            <div class="card" style="background-color: white; border: 5px solid #039479; border-color: #039479;">
                                <p style=" padding: 20px;"><b>Hari, Tanggal:</b> Jumat - Minggu, 31 Mei - 2 Juni 2024<br>
                                <b>Pukul:</b> 07.00 WIB - selesai <br>
                                <b>Tempat:</b> Pulau Pari, Kepulauan Seribu</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 text-center center-col margin-eight-bottom xs-margin-30px-bottom last-paragraph-no-margin">
                            ...
                            <div class="row margin-four-bottom xs-margin-10px-bottom">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;">Edukasi Maritim</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 2 -->
                            <div class="row margin-four-bottom xs-margin-10px-bottom">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;"><i>Blue Economy Business Visit</i></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 3 -->
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;">Konservasi dan Penanaman Mangrove</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 4 -->
                            <div class="row margin-four-bottom xs-margin-10px-bottom">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;">FGD Potensi Pulau Pari</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 5 -->
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;">Upacara Peringatan Hari Lahir Pancasila</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 6 -->
                            <div class="row margin-four-bottom xs-margin-10px-bottom">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;"><i>Marine Sport Tourism: Snorkeling & Diving</i></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 7 -->
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;"><i>Coastal Clean Up</i></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 8 -->
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;">Eksplor Pulau Pari</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 9 -->
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    <div class="card" style="border-radius: 0 0 20px 20px; background-color: #f7f0d3; border: 5px solid #f7f0d3; border-color: #f7f0d3;">
                                        <p class="text-left xs-text-center" style="color: #030a95; padding: 20px;"><i>Fun Games</i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row margin-four-bottom xs-margin-10px-bottom">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card" style="border-radius: 20px; background-color: white; border: 5px solid #f84535; border-color: #f84535;">
                                        ...
                                        3. Mengikuti seluruh rangkaian edutrip</p>
                                    </div>
                                </div>
                            </div>
                        </div>
