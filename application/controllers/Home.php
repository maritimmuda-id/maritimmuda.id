...
class Home extends CI_Controller
{
	...
	public function arungisamudra()
	{
		...
		$data['page_css'] = $this->load->view('arungisamudra/home_css', $data, TRUE);
	...
	public function arungisamudra_bootcamp_daftar()
	{
		$data = $this->data;
	...
	public function arungisamudra_edutrip_daftar()
	{
		$data = $this->data;
